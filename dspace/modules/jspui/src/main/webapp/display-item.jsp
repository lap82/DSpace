...
<%
    ...
    boolean pubMedEnabled = ConfigurationManager.getBooleanProperty("retrieve.pubmed.enable");
%>
	...
	ajaxPMCCitedBy = function(args) {
		new Ajax.Request("<%= request.getContextPath() %>/pmcCitedBy?item_id=" + encodeURIComponent(args), {
			...
			onComplete: function(transport) {
				var respPmc = String(transport.responseText);
					$('pmc-cited-by').replace(respPmc);
			}
		});
	};
